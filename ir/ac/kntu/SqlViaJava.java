...
public class ProjectDataBase {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("(Enter " + BLUE + "help" + RESET + " for command info Or enter " + RED + "quit" + RESET + " to quit the app)");
            ...
            switch (command) {
                ...
                default -> System.out.println(RED + "Error! '" + command + "' is not recognized as a valid command.\n" + RESET);
            }
        }
    }
    ...
    public static int extractTheColumnNamesAndItsDataAndReturnTheNumberOfColumnsUnderDiscussion(String input, String[] columnNames, String[] data) {
    ...
    public static void createTable(String input) {
        ...
        int numberOfDataAndFilters = extractTheColumnNamesAndItsDataAndReturnTheNumberOfColumnsUnderDiscussion(input, columnNames, dataTypes);
    ...
    public static void initializeColumnNamesToFirstRow(String[][] table, String[] columnNames, int numberOfDataAndFilters) {
        if (numberOfDataAndFilters >= 0) System.arraycopy(columnNames, 0, table[0], 0, numberOfDataAndFilters);
    }
    ...
    public static String addRowToTable(String input) {
        ...
        int numberOfDataAndFilters = extractTheColumnNamesAndItsDataAndReturnTheNumberOfColumnsUnderDiscussion(input, columnNames, addingData);
    ...
    public static void initializeTableBasedOnGivenData(String[][] table, String[] columnNames, String[] data, String tableName, int emptyRow, int numberOfDataAndFilters) {
        for (int i = 0; i < table[0].length; i++) {
        ...
        if (isTheNameOfTheTableEnteredCorrectly("\\w+\\s*\\(", input)) {
            ...
            if (matcher.find()) {
                ...
                for (int i = 1; i < table.length; i++) {
                    if (table[i][0] != null) {
                        for (int j = 0; j < table[0].length; j++) {
                            if (elementsOfRightSide.getFirst().equals(table[i][j]) && elementsOfLeftSide.getFirst().equals(table[0][j])) {
    ...
    public static boolean isElementOfTypeInt(String[][] table, String tableName, String columnName) {
        return (connectTableNamesToTypes.get(tableName).get(table[0][returnColumnIndex(columnName, table)]).equals("int"));
    }
    public static boolean isElementOfTypeDouble(String[][] table, String tableName, String columnName) {
        return (connectTableNamesToTypes.get(tableName).get(table[0][returnColumnIndex(columnName, table)]).equals("dbl"));
    }
    public static boolean isElementOfTypeStr(String[][] table, String tableName, String columnName) {
        return (connectTableNamesToTypes.get(tableName).get(table[0][returnColumnIndex(columnName, table)]).equals("str"));
    }
    ...
    public static double calculateEverySide(String[][] table, ArrayList<String> elementsOfSide, String tableName, int row) {
        double temp = 0.0;
            ...
            if (i % 2 == 0) {
                if (isANumber(elementsOfSide.get(i))) {
                    temp = Double.parseDouble(elementsOfSide.get(i));
                     ...
                     if (isElementOfTypeInt(table, tableName, elementsOfSide.get(i)) || isElementOfTypeDouble(table, tableName, elementsOfSide.get(i))){
    ...
    public static int setRow(String input) {
        ...
        if (isTheNameOfTheTableEnteredCorrectly("\\w+\\s*\\{", input)) {
            ...
            int numberOfDataAndFilters = extractTheColumnNamesAndItsDataAndReturnTheNumberOfColumnsUnderDiscussion(input, columnNames, settingData);
            ...
            int numberOfColumnsAndFilters = extractTheColumnNamesAndItsDataAndReturnTheNumberOfColumnsUnderDiscussion(inputOfFilters, columnNamesOfFilters, filters);
            int numberOfColumnsAndSettingData = extractTheColumnNamesAndItsDataAndReturnTheNumberOfColumnsUnderDiscussion(inputOfData, columnNamesOfSetters, settingData);
            ...
            int numberOfSetLines = setFilteredRowsAndReturnTheCount(table, columnNamesOfSetters, settingData, changingRows, numberOfColumnsAndFilters);
    ...
    public static int setRowsAndCountThem(String[][] table, String[] columnNames, String[] settingData, int numberOfDataAndFilters) {
        int counter = 0;
    ...
    public static int setFilteredRowsAndReturnTheCount(String[][] table, String[] columnNamesOfSetters, String[] settingData, int[] changingRows, int numberOfFilters) {
    ...
    public static int delRow(String input) {
        ...
        if (isTheNameOfTheTableEnteredCorrectly("\\w+\\s*\\(", input)) {
            ...
            int numberOfFilters = extractTheColumnNamesAndItsDataAndReturnTheNumberOfColumnsUnderDiscussion(input, columnNames, filters);
